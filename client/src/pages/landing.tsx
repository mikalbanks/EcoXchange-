...
const STATS = [
  {
    num: "Bankability & Sponsor Equity",
...
const PROBLEM_CARDS = [
  {
    num: "01",
    title: "Financing requirements are hard to see early",
    body: "Developers need a fast, explainable view of how contracted cash flow, lender assumptions, and tax-credit monetization affect debt capacity and sponsor equity.",
  },
  {
    num: "02",
  ...
  {
    num: "03",
    title: "Operating evidence loses context",
    body: "Production evidence and distribution controls are rarely connected to the same project-level operating record.",
  },
] as const;
...
const PILOT_ROWS = [
  { label: "Bankability analysis", eco: "Included", other: "Indicative project-finance analysis; no lender commitment" },
  ...
  return (
    <div className="landing-page">
      ...
      <section>
        <div className="hero">
          <div className="hero-text">
            <div className="label hero-eyebrow">Project Finance Analysis · Ownership · Operating Evidence</div>
            <h1 className="hero-headline">The operating layer for<br /><em>investable distributed energy.</em></h1>
            <p className="hero-sub"><strong>Understand how much permanent debt your project may support — and how much sponsor equity remains.</strong> EcoXchange connects project economics to lender-style financing analysis, tax-credit monetization, project records, production evidence, and controlled operating workflows.</p>
            <p className="hero-sub">Project economics → CFADS → indicative debt capacity → tax-credit proceeds → sponsor-equity requirement → financing constraints.</p>
            <div className="hero-actions">
              <Link href="/bankability" className="btn btn-primary">Explore Bankability Analysis</Link>
              <a href="https://demo.ecoxchange.net/bankability" className="btn btn-outline">See a 5 MW Financing Example</a>
              <Link href="/develop" className="btn btn-outline">For Developers →</Link>
            </div>
          </div>
      ...
      <section id="problem" className="problem">
        <div className="section-header"><span className="label section-num">§ I</span><h2 className="section-title">Make financing requirements visible before they become surprises.</h2></div>
        <p className="problem-intro">EcoXchange gives renewable-project sponsors an auditable financing view alongside the project-level operating infrastructure required to keep economics, ownership, evidence, and reporting in context.</p>
      ...
      <section id="verification" className="method">
        <div className="method-inner">
          <div className="section-header"><span className="label section-num">§ II</span><h2 className="section-title">Three evidence roles. One monthly determination.</h2></div>
      ...
      <section id="investors" className="investors">
        <div className="section-header"><span className="label section-num">§ III</span><span className="label">Connected Application · Project-Level Capital Administration</span><h2 className="section-title">One operating record from project economics to distribution eligibility.</h2></div>
        <div className="investors-grid">
          <div className="investors-body"><p>EcoXchange is preparing a non-transactional pilot for individual U.S. solar projects. The pilot can connect indicative bankability analysis, technical project intake, source-labeled production analysis, digital ownership and cap-table workflow review, and modeled PPA-based pro-rata allocation in one project context.</p><p className="investors-note">Bankability results are indicative analyses and do not constitute a financing commitment, lender approval, tax opinion, legal advice, or securities offering. The demo does not accept investments, create legal ownership, or execute distributions.</p><Link href="/develop" className="btn btn-primary">View Pilot Scope →</Link></div>
      ...
      <section id="benchmark" className="benchmark-module">
        <div className="section-header"><span className="label section-num">§ IV</span><h2 className="section-title">Tested against reported U.S. solar generation.</h2></div>
      ...
      <section id="fee" className="fee"><div className="fee-inner"><div className="section-header"><span className="label section-num">§ V</span><h2 className="section-title">Release 1 non-transactional pilot boundaries.</h2></div><div className="fee-grid"><div className="fee-body"><p>Release 1 is a <strong>connected, non-transactional pilot</strong>. It combines indicative project-finance analysis, project intake, production evidence, ownership-workflow review, and modeled distribution controls; it is not a lending commitment or securities offering.</p><p>Pilot timing, data-access responsibilities, and any commercial terms are confirmed separately in writing after a fit review.</p><p>Offering, subscription, legal ownership, legal-document, and payment execution remain disabled until the necessary authoritative systems, partners, and approvals are in place.</p></div><div><div className="fee-table"><div className="fee-table-head">Pilot Scope</div><div className="fee-row fee-row-labels"><span /><span>Release 1</span><span>Boundary</span></div>{PILOT_ROWS.map((row) => <div key={row.label} className="fee-row"><span>{row.label}</span><span className="fee-yes">{row.eco}</span><span className="fee-no">{row.other}</span></div>)}<div className="fee-row fee-total"><span>Pilot objective</span><span>Validate the connected operating workflow</span><span className="fee-no">Do not imply a live transaction</span></div></div></div></div></div></section>

      <section id="access" className="access"><div className="access-inner"><div className="label">Request Pilot Access · Partners and Project Operators</div><h2 className="access-headline">A short conversation.</h2><div className="access-tracks"><div className="access-track"><p>Review bankability, ownership, evidence, and distribution-control workflows and discuss pilot requirements.</p><Link href={REQUEST_ACCESS.href} className="btn btn-lime">Request Pilot Access</Link></div><div className="access-track"><p>Submit a project for an independent 12-month production backtest.</p><Link href="/develop" className="btn btn-outline" style={{ color: "#fff", borderColor: "rgba(255,255,255,.4)" }}>Start a Project Backtest →</Link></div></div><p className="access-legal">No offering is currently open. This page is for pilot evaluation and informational purposes only; it does not accept investments, execute payments, or constitute a solicitation of securities.</p></div></section>

      <footer><div className="map-ticks map-ticks-bottom" aria-hidden="true" /><div className="footer-inner"><span className="footer-brand">EcoXchange</span><span className="footer-meta">Non-Transactional Pilot · © MMXXVI</span><span className="footer-meta">Project Finance × Ownership × Operating Evidence</span></div></footer>
    </div>
  );
}
