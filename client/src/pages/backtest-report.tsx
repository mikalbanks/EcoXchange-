              ...
              <div className="md:col-span-2 space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 print:text-gray-600 leading-relaxed" data-testid="text-validation-statement">
                    {data.satelliteSource === "SOLCAST_HISTORICAL" ? (
                      <>
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge
                    className={data.satelliteSource === "SOLCAST_HISTORICAL"
                      ? "bg-primary/20 text-primary border-primary/30"
                      : "bg-yellow-500/20 text-yellow-400 border-yellow-500/30"}
                    data-testid="badge-satellite-source"
                  >
                    {data.satelliteSource === "SOLCAST_HISTORICAL" ? "🛰️ Solcast Historical" : "⚠️ Synthetic Fallback"}
                  </Badge>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              <div className="space-y-3">
                ...
                <ul className="space-y-1 text-muted-foreground print:text-gray-700">
                  ...
                  <li>Data source: <strong>{data.satelliteSource === "SOLCAST_HISTORICAL" ? "Solcast Historical" : "Synthetic Fallback"}</strong></li>
                </ul>
              </div>
              <div className="space-y-3">
